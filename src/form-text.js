...
export default function FormText(){
    ...
    return(
        <div className="mt-4 mx-auto p-3 roundded" style={{width:'400px',background:'#cee'}}>
            <form>
                ...
                <input type="password" id="pswd" name="pswd" maxLength="10" className="form-control
                 form-control-sm" ref={textPswd} onBlur={onBlurPassword}/>
                </div>
                <div className="form-group mb-2">
